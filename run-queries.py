...
def main():  
    ...
    execute_sql_file(install_folder + '/sql/ssc_canvas_enrollment_role_counts.sql', canvasdata_config)
    print("/usr/local/canvasdata/sql/ssc_course_info_dl_inst.sql")
    execute_sql_file(install_folder + '/sql/ssc_course_info_dl_inst.sql', canvasdata_config)
    print("/usr/local/canvasdata/sql/ssc_discussion_inst_counts.sql")
    execute_sql_file(install_folder + '/sql/ssc_discussion_inst_counts.sql', canvasdata_config)
    print("/usr/local/canvasdata/sql/ssc_assignment_counts.sql")
    execute_sql_file(install_folder + '/sql/ssc_assignment_counts.sql', canvasdata_config)
    print("/usr/local/canvasdata/sql/ssc_conversation_course_counts.sql")
    execute_sql_file(install_folder + 'sql/ssc_conversation_course_counts.sql', canvasdata_config)
    print("/usr/local/canvasdata/sql/ssc_discussion_counts.sql")
    execute_sql_file(install_folder + '/sql/ssc_discussion_counts.sql', canvasdata_config)
